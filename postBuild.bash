...
/opt/conda/envs/api-env/bin/pip install \
    fastapi==0.109.2 \
...
# /opt/conda/envs/ui-env/bin/pip install dataclass_wizard==0.22.2 gradio==3.48.0 jinja2==3.1.2 numpy==1.25.2 protobuf==3.20.3 PyYAML==6.0 uvicorn==0.22.0
